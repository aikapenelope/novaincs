...
/**
 * Checkout buyer info — /t/:tenantSlug/checkout
 *
 * Only 2 required fields: name + WhatsApp number.
 * State persisted in sessionStorage to survive app-switch to banking app.
 */
...
function proceed() {
  ...
  persistCheckout();
  router.push(`/t/${tenantSlug.value}/checkout/payment`);
}
...
<template>
  <div class="checkout-page">
    <NuxtLink :to="`/t/${tenantSlug}/cart`" class="back-link">&larr; Volver al carrito</NuxtLink>
