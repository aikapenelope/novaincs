CREATE TABLE "exchange_rates" (
	...
	"from_currency" varchar(10) DEFAULT 'USD' NOT NULL,
	"to_currency" varchar(10) DEFAULT 'VES' NOT NULL,
...
CREATE TABLE "tenants" (
	...
	"plan_overrides" jsonb DEFAULT '{}'::jsonb NOT NULL,
...
CREATE TABLE "customers" (
	...
	"visitor_ids" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"notes" text,
	"metadata" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
...
--> statement-breakpoint
ALTER TABLE "payment_configs" ADD CONSTRAINT "payment_configs_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "exchange_rates_effective_idx" ON "exchange_rates" USING btree ("effective_at");--> statement-breakpoint
CREATE INDEX "exchange_rates_source_idx" ON "exchange_rates" USING btree ("source","effective_at");--> statement-breakpoint
CREATE INDEX "payment_configs_tenant_idx" ON "payment_configs" USING btree ("tenant_id");--> statement-breakpoint
...
CREATE INDEX "product_variants_tenant_sku_idx" ON "product_variants" USING btree ("tenant_id","sku");--> statement-breakpoint
