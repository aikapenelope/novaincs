...
> **See [doc 12 — Complete Stack Explained](12-COMPLETE-STACK-EXPLAINED.md)** for the definitive production architecture: 8 containers, 3 PostgreSQL instances, docker-compose.yml, memory budget, failure scenarios, and costs.
